...
var _dreamdata = global.dreamdata;
...
Analytics.prototype._parseQuery = function(query) {
    ...
    var traits = pickPrefix('dda_trait_', q);
    var props = pickPrefix('dda_prop_', q);
    // Trigger based on callable parameters in the URL
    if (q.dda_uid) this.identify(q.dda_uid, traits);
    if (q.dda_event) this.track(q.dda_event, props);
    if (q.dda_aid) user.anonymousId(q.dda_aid);
    return this;
